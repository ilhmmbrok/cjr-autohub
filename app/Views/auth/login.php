        ...
        <div class="hidden lg:flex lg:w-1/2 login-bg relative flex-col justify-between p-10">
            ...
            <div class="relative z-10 anim-slide delay-3">
                <blockquote class="text-lg text-white/90 font-medium leading-relaxed mb-4">
                    "Proses booking jadi lebih mudah dan cepat. Tidak perlu lagi antri atau telepon untuk reservasi servis kendaraan."
                </blockquote>
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 bg-white">
            <div class="w-full max-w-[360px]">
                ...
                <div class="mb-6 anim-fade delay-1 text-center">
                    <h1 class="text-2xl font-semibold text-zinc-950 tracking-tight">Login</h1>
                    <p class="text-sm text-zinc-500 mt-1">Masukkan email dan password untuk masuk</p>
                </div>
                ...
                <form class="space-y-4" method="POST" action="/login">
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-zinc-950 leading-none anim-fade delay-2" for="email">Email</label>
                        <input type="email" id="email" name="email" placeholder="nama@email.com" required
                            class="flex h-9 w-full rounded-lg border border-zinc-200 bg-transparent px-3 py-1 text-sm shadow-xs transition-colors placeholder:text-zinc-400 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600/10 anim-fade delay-2">
                    </div>

                    <div class="space-y-2">
                        <label class="text-sm font-medium text-zinc-950 leading-none anim-fade delay-3" for="password">Password</label>
                        <div class="relative">
                            <input type="password" id="password" name="password" placeholder="••••••••" required
                                class="flex h-9 w-full rounded-lg border border-zinc-200 bg-transparent px-3 pr-9 py-1 text-sm shadow-xs transition-colors placeholder:text-zinc-400 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600/10 anim-fade delay-4">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center h-9 w-full rounded-lg bg-zinc-950 px-4 text-sm font-medium text-white shadow-xs hover:bg-zinc-800 transition-colors active:scale-[0.98] cursor-pointer anim-fade delay-5">
                        Login
                    </button>
                </form>
                ...
                <p class="mt-6 text-center text-sm text-zinc-500 anim-fade delay-5">
                    Belum punya akun?
                    <a href="/register" class="text-zinc-950 font-medium underline underline-offset-4 hover:text-zinc-700 transition-colors">Register</a>
                </p>
            </div>
        </div>
    </div>
