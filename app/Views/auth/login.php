        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 bg-white">
            <div class="w-full max-w-[360px]">
                ...
                <form class="space-y-4" method="POST" action="/login">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="password" id="password" name="password" placeholder="••••••••" required
                                class="flex h-9 w-full rounded-full border border-zinc-200 bg-transparent px-3 pr-9 py-1 text-sm shadow-xs transition-colors placeholder:text-zinc-400 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600/10 anim-fade delay-4">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center h-9 w-full rounded-full bg-zinc-950 px-4 text-sm font-medium text-white shadow-xs hover:bg-zinc-800 transition-colors active:scale-[0.98] cursor-pointer anim-fade delay-5">
                        Login
                    </button>
                </form>
