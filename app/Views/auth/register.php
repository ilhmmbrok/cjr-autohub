            ...
            <div class="max-w-md w-full">
                <div class="p-6 rounded-4xl bg-white border border-zinc-200 shadow-sm md:p-8">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <div>
                            <h1 class="text-zinc-900 text-center text-2xl font-semibold mb-1">Register</h1>
                            <p class="text-zinc-500 text-center text-sm mb-6">Buat akun baru</p>
                        </div>
                    </div>

                    <form class="space-y-4" method="POST" action="/register">
                        <div>
                            <label class="block text-sm font-medium text-zinc-900 mb-1.5" for="fullname">
                        ...
                        <div class="text-zinc-600 text-sm text-center">Sudah punya akun? <a href="/login"
                                class="text-zinc-900 hover:underline font-medium">Login</a>
                        </div>
                    </form>
                </div>
            </div>
