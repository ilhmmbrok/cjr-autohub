        ...
        <aside id="sidebar" class="w-64 shrink-0 bg-white border-r border-zinc-200 flex flex-col print:hidden" style="position: sticky; top: 0; height: 100vh; overflow-y: auto; overflow-x: hidden; flex-shrink: 0;">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1">
                ...
                <a href="/admin/profile"
                    ...
                    class="nav-item flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 active:scale-[0.98]
                    <?= $path === '/admin/profile' ? 'bg-zinc-100 text-zinc-950' : 'text-zinc-700 hover:bg-zinc-100 hover:text-zinc-950' ?>">
                    <svg class="w-5 h-5 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-icon lucide-user"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
