...
<div class="w-full bg-white px-4 sm:px-6 lg:px-8 py-8 animate-fadeInUp">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-zinc-400 mb-3">
            ...
            <span>/</span>
            <span class="text-zinc-900 font-medium">Profile</span>
        </div>
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-semibold text-zinc-950 tracking-tight">Informasi Akun</h1>
                <p class="text-sm text-zinc-500 mt-0.5">Perbarui nama, email, dan nomor telepon Anda</p>
            </div>
        </div>
    </div>
