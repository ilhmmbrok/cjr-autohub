                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3" placeholder="Alamat Lengkap" required
                            class="w-full px-3 py-2 rounded-lg border text-sm border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 transition-all resize-none placeholder:text-zinc-400"><?= htmlspecialchars($_POST['address'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative custom-select" id="checkin-time-select">
                            <button type="button" 
                                ...
                                <span class="selected-label"><?= !empty($_POST['checkin_time']) ? $_POST['checkin_time'] : 'Pilih jam kedatangan' ?></span>
                            ...
                            <input type="hidden" name="checkin_time" id="checkin_time" value="<?= $_POST['checkin_time'] ?? '' ?>" required>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="customer_complaint" id="customer_complaint" rows="5"
                            ...
                            class="w-full h-20 md:h-41 px-3 py-2 rounded-lg border text-sm border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 transition-all resize-none placeholder:text-zinc-400"><?= htmlspecialchars($_POST['customer_complaint'] ?? '') ?></textarea>
                    </div>
                </div>
            </div>
