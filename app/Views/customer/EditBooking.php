...
<div class="w-full bg-white min-h-[calc(100vh-56px)] px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            <div class="flex items-center gap-2 text-sm text-zinc-400 mb-3">
                ...
                <span>/</span>
                <a href="/history-booking" class="hover:text-zinc-950 transition-colors">Riwayat</a>
                <span>/</span>
        ...
        <div class="rounded-2xl border border-zinc-200 bg-white overflow-hidden pb-4 shadow-[0px_1px_3px_rgba(0,0,0,0.1)]">
            <form action="/edit-booking/<?= htmlspecialchars($booking['booking_id']) ?>" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" placeholder="Alamat Lengkap" required
                                class="w-full px-3 py-2 rounded-lg border text-sm border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 transition-all resize-none placeholder:text-zinc-400"><?= htmlspecialchars($booking['address'] ?? '') ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" id="date" name="date"
                                ...
                                required
                                class="h-9 w-full px-3 py-2 rounded-lg text-sm border border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 transition-all">
                        </div>
                        ...
                        <div class="relative custom-select" id="checkin-time-select">
                            <button type="button" 
                                ...
                                <span class="selected-label"><?= !empty($booking['checkin_time']) ? substr($booking['checkin_time'], 0, 5) : 'Pilih jam kedatangan' ?></span>
                            ...
                            <input type="hidden" name="checkin_time" id="checkin_time" value="<?= $booking['checkin_time'] ?? '' ?>" required>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="plate_number" name="plate_number"
                                    ...
                                    value="<?= htmlspecialchars($booking['plate_number'] ?? '') ?>"
                                    required
                        ...
                        <div>
                            ...
                            <input type="text" id="model_year" name="model_year"
                                ...
                                value="<?= htmlspecialchars($booking['model_year'] ?? '') ?>"
                                required
                                class="h-9 w-full px-3 py-2 rounded-lg border text-sm border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 transition-all placeholder:text-zinc-400">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="customer_complaint" id="customer_complaint" rows="5"
                                ...
                                class="w-full h-20 md:h-41 px-3 py-2 rounded-lg border text-sm border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 transition-all resize-none placeholder:text-zinc-400"><?= htmlspecialchars($booking['customer_complaint'] ?? '') ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 flex justify-end gap-3 border-t border-zinc-50">
                    <a href="/dashboard">
                        <button type="button" class="h-9 text-xs px-4 py-2 rounded-md border border-zinc-200 bg-white font-medium text-zinc-700 hover:bg-zinc-50 active:scale-95 transition-all duration-200">
                            Batal
                        </button>
                    </a>
                    <button type="submit" class="h-9 text-xs px-4 py-2 rounded-md bg-zinc-950 font-medium text-white hover:bg-zinc-900 active:scale-95 transition-all duration-200">
                        Update Booking
                    </button>
                </div>
            </form>
