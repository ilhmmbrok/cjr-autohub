...
$savedTime = !empty($booking['checkin_time']) ? substr($booking['checkin_time'], 0, 5) : '';
?>
    ...
    <div class="rounded-2xl border border-zinc-200 bg-white overflow-hidden pb-4 shadow-[0px_1px_3px_rgba(0,0,0,0.1)]">
        <form action="/edit-booking/<?= htmlspecialchars($booking['booking_id']) ?>" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3" placeholder="Alamat Lengkap" required
                            class="w-full px-3 py-2 rounded-lg border text-sm border-zinc-200 bg-white text-zinc-950 focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10 hover:border-zinc-300 transition-all resize-none placeholder:text-zinc-400"><?= htmlspecialchars($booking['address'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative custom-select" id="checkin-time-select">
                            <button type="button"
                                ...
                                <span class="selected-label"><?= $savedTime ?: 'Pilih jam kedatangan' ?></span>
                            ...
                            <input type="hidden" name="checkin_time" id="checkin_time"
                                value="<?= htmlspecialchars($savedTime) ?>" required>
                        </div>
            ...
            <div class="px-6 py-4 flex justify-end gap-3 border-t border-zinc-50">
                <a href="/detail-booking/<?= $booking['booking_id'] ?>">
