    ...
    <div class="space-y-4">
        ...
        <div class="rounded-lg border border-zinc-200 bg-white p-6">
            <div class="mb-5">
                ...
                <p class="text-xs text-zinc-400 mt-0.5">Daftar semua booking kendaraan Anda.</p>
            </div>

            <?php if (empty($bookings)): ?>
                <div class="text-center py-16 text-slate-400">
                    <p class="font-medium text-slate-500 text-base md:text-lg">Belum ada booking</p>
                    <p class="text-xs mt-1 md:text-base">Buat booking pertama Anda sekarang.</p>
                </div>
            <?php else: ?>
                            ...
                            <?php foreach ($bookings as $booking): ?>
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="py-3 pr-4 text-slate-800 font-medium">
                                        ...
                                        <div class="text-xs text-slate-400 font-normal capitalize"><?= htmlspecialchars($booking['vehicle_type']) ?></div>
                                    </td>
                                    <td class="py-3 pr-4 text-slate-600 font-mono uppercase">
